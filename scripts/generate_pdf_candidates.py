...
questions = [
  # Module 1: Intro
  {
    ...
    "options": [
      {"label": "A", "text": "Eliminating the need to manage software licenses", "isCorrect": False},
      {"label": "B", "text": "Paying only for computing resources as they are consumed", "isCorrect": True},
      {"label": "C", "text": "Deploying applications globally in minutes", "isCorrect": False},
      {"label": "D", "text": "Removing the need for a corporate IT department", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Stop guessing capacity", "isCorrect": True},
      {"label": "B", "text": "Go global in minutes", "isCorrect": False},
      {"label": "C", "text": "Increase speed and agility", "isCorrect": False},
      {"label": "D", "text": "Massive economies of scale", "isCorrect": False}
    ],
    ...
    "topic": "Cloud Advantages",
    "difficulty": "MEDIUM",
    "tags": ["Agility", "Elasticity", "Module 1"],
    "sourceModule": "Module 1 - Introduction to Amazon Web Services",
    "source": "Module 01",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Private cloud", "isCorrect": False},
      {"label": "B", "text": "Community cloud", "isCorrect": False},
      {"label": "C", "text": "Hybrid cloud", "isCorrect": True},
      {"label": "D", "text": "Public cloud", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {"label": "B", "text": "Platform as a Service (PaaS)", "isCorrect": False},
      {"label": "C", "text": "Software as a Service (SaaS)", "isCorrect": False},
      {"label": "D", "text": "Function as a Service (FaaS)", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Full administrative access to the underlying hardware", "isCorrect": False},
      {"label": "B", "text": "Reduced operational overhead since AWS manages the OS and runtime environment", "isCorrect": True},
      {"label": "C", "text": "The ability to run custom hypervisors", "isCorrect": False},
      {"label": "D", "text": "Lower overall cost because PaaS is always cheaper than IaaS", "isCorrect": False}
    ],
    ...
    "topic": "Service Models",
    "difficulty": "HARD",
    "tags": ["PaaS", "IaaS vs PaaS", "Module 1"],
    "sourceModule": "Module 1 - Introduction to Amazon Web Services",
    "source": "Module 01",
  ...
  # Module 2: Compute
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Lambda", "isCorrect": False},
      {"label": "B", "text": "Amazon Elastic Compute Cloud (Amazon EC2)", "isCorrect": True},
      {"label": "C", "text": "Amazon Elastic Container Service (Amazon ECS)", "isCorrect": False},
      {"label": "D", "text": "AWS Fargate", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon EC2", "isCorrect": False},
      {"label": "B", "text": "AWS Lambda", "isCorrect": True},
      {"label": "C", "text": "Amazon Lightsail", "isCorrect": False},
      {"label": "D", "text": "AWS Outposts", "isCorrect": False}
    ],
    ...
    "topic": "Serverless",
    "difficulty": "MEDIUM",
    "tags": ["Lambda", "Serverless", "Module 2"],
    "sourceModule": "Module 2 - Compute in the Cloud",
    "source": "Module 02",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "On-Demand Instances", "isCorrect": False},
      {"label": "B", "text": "Reserved Instances", "isCorrect": False},
      {"label": "C", "text": "Spot Instances", "isCorrect": True},
      {"label": "D", "text": "Dedicated Hosts", "isCorrect": False}
    ],
    ...
    "difficulty": "MEDIUM",
    "tags": ["Pricing", "Spot Instances", "Module 2"],
    "sourceModule": "Module 2 - Compute in the Cloud",
    "source": "Module 02",
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "On-Demand Instances", "isCorrect": False},
      {"label": "B", "text": "Dedicated Instances", "isCorrect": False},
      {"label": "C", "text": "Dedicated Hosts", "isCorrect": True},
      {"label": "D", "text": "Savings Plans", "isCorrect": False}
    ],
    ...
    "difficulty": "HARD",
    "tags": ["Dedicated Hosts", "Licensing", "Module 2"],
    "sourceModule": "Module 2 - Compute in the Cloud",
    "source": "Module 02",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Elastic Beanstalk is a serverless database, while CloudFormation is a compute service.", "isCorrect": False},
      {"label": "B", "text": "Elastic Beanstalk focuses on simplifying application deployment, while CloudFormation provides complete infrastructure-as-code control over almost all AWS resources.", "isCorrect": True},
      {"label": "C", "text": "Elastic Beanstalk uses JSON/YAML templates, while CloudFormation only supports Python.", "isCorrect": False},
      {"label": "D", "text": "Elastic Beanstalk is used for billing management, while CloudFormation is used for monitoring.", "isCorrect": False}
    ],
    ...
    "difficulty": "HARD",
    "tags": ["Elastic Beanstalk", "CloudFormation", "Service Comparison", "Module 2"],
    "sourceModule": "Module 2 - Compute in the Cloud",
    "source": "Module 02",
  ...
  # Module 3: Global Infrastructure
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Edge Location", "isCorrect": False},
      {"label": "B", "text": "Availability Zone", "isCorrect": True},
      {"label": "C", "text": "AWS Outpost", "isCorrect": False},
      {"label": "D", "text": "Local Zone", "isCorrect": False}
    ],
    ...
    "difficulty": "EASY",
    "tags": ["Availability Zone", "Module 3"],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Regions", "isCorrect": False},
      {"label": "B", "text": "Availability Zones", "isCorrect": False},
      {"label": "C", "text": "Edge Locations", "isCorrect": True},
      {"label": "D", "text": "AWS Direct Connect locations", "isCorrect": False}
    ],
    ...
    "difficulty": "MEDIUM",
    "tags": ["Edge Locations", "CloudFront", "Module 3"],
    "sourceModule": "Module 3 - Global Infrastructure and Reliability",
    "source": "Module 03",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Across multiple data centers within a single Availability Zone", "isCorrect": False},
      {"label": "B", "text": "Across multiple Availability Zones within a single AWS Region", "isCorrect": False},
      {"label": "C", "text": "Across multiple AWS Regions", "isCorrect": True},
      {"label": "D", "text": "Using a single large EC2 instance with regular EBS snapshots", "isCorrect": False}
    ],
    ...
    "difficulty": "HARD",
    "tags": ["Disaster Recovery", "Multi-Region", "Module 3"],
    "sourceModule": "Module 3 - Global Infrastructure and Reliability",
    "source": "Module 03",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon CloudFront", "isCorrect": True},
      {"label": "B", "text": "Amazon S3 Transfer Acceleration", "isCorrect": False},
      {"label": "C", "text": "AWS Global Accelerator", "isCorrect": False},
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Enable AWS Shield Advanced", "isCorrect": False},
      {"label": "B", "text": "Select an AWS Region located entirely within that country and deploy data only to that Region", "isCorrect": True},
      {"label": "C", "text": "Configure Edge Locations to strictly route traffic within the country", "isCorrect": False},
      {"label": "D", "text": "Use AWS IAM to restrict geographic access based on user IP addresses", "isCorrect": False}
    ],
    ...
    "difficulty": "MEDIUM",
    "tags": ["Compliance", "Regions", "Module 3"],
    "sourceModule": "Module 3 - Global Infrastructure and Reliability",
    "source": "Module 03",
  ...
  # Module 4: Networking
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Direct Connect", "isCorrect": False},
      {"label": "B", "text": "Amazon Route 53", "isCorrect": False},
      {"label": "C", "text": "Amazon Virtual Private Cloud (Amazon VPC)", "isCorrect": True},
      {"label": "D", "text": "AWS Transit Gateway", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Place all servers in a public subnet and use Security Groups to block the internet from reaching the databases.", "isCorrect": False},
      {"label": "B", "text": "Place the web servers in a public subnet and the database servers in a private subnet.", "isCorrect": True},
      {"label": "C", "text": "Place all servers in a private subnet and attach an Internet Gateway to the database servers only.", "isCorrect": False},
      {"label": "D", "text": "Use AWS Transit Gateway to route internet traffic directly to the web servers and block all database traffic.", "isCorrect": False}
    ],
    ...
    "topic": "Networking",
    "difficulty": "MEDIUM",
    "tags": ["Subnets", "Architecture", "Module 4"],
    "sourceModule": "Module 4 - Networking",
    "source": "Module 04",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Network Access Control List (NACL)", "isCorrect": False},
      {"label": "B", "text": "Route Table", "isCorrect": False},
      {"label": "C", "text": "Security Group", "isCorrect": True},
      {"label": "D", "text": "Internet Gateway", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Security groups support 'deny' rules, while Network ACLs only support 'allow' rules.", "isCorrect": False},
      {"label": "B", "text": "Security groups operate at the subnet level, while Network ACLs operate at the instance level.", "isCorrect": False},
      {"label": "C", "text": "Security groups are stateful, while Network ACLs are stateless.", "isCorrect": True},
      {"label": "D", "text": "Security groups require an Internet Gateway, while Network ACLs do not.", "isCorrect": False}
    ],
    ...
    "topic": "Network Security",
    "difficulty": "HARD",
    "tags": ["Comparison", "Security Group vs NACL", "Module 4"],
    "sourceModule": "Module 4 - Networking",
    "source": "Module 04",
    "concept": "SG vs NACL"
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "VPC Peering", "isCorrect": False},
      {"label": "B", "text": "AWS Transit Gateway", "isCorrect": True},
      {"label": "C", "text": "AWS Direct Connect", "isCorrect": False},
      {"label": "D", "text": "AWS PrivateLink", "isCorrect": False}
    ],
    ...
    "topic": "Networking",
    "difficulty": "MEDIUM",
    "tags": ["Transit Gateway", "Architecture", "Module 4"],
    "sourceModule": "Module 4 - Networking",
    "source": "Module 04",
    "concept": "Transit Gateway"
  },

  # Module 5: Storage & DBs
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon Elastic Block Store (Amazon EBS)", "isCorrect": False},
      {"label": "B", "text": "Amazon Elastic File System (Amazon EFS)", "isCorrect": False},
      {"label": "C", "text": "Amazon Simple Storage Service (Amazon S3)", "isCorrect": True},
      {"label": "D", "text": "Amazon DynamoDB", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon RDS", "isCorrect": False},
      {"label": "B", "text": "Amazon Redshift", "isCorrect": False},
      {"label": "C", "text": "Amazon DynamoDB", "isCorrect": True},
      {"label": "D", "text": "Amazon Aurora", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "options": [
      ...
      {"label": "B", "text": "Amazon EFS", "isCorrect": False},
      {"label": "C", "text": "Amazon EBS", "isCorrect": True},
      {"label": "D", "text": "Amazon Glacier", "isCorrect": False}
    ],
    ...
    "topic": "Storage",
    "difficulty": "HARD",
    "tags": ["Storage Comparison", "EBS", "Module 5"],
    "sourceModule": "Module 5 - Storage and Databases",
    "source": "Module 05",
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "Amazon RDS", "isCorrect": False},
      {"label": "B", "text": "Amazon Redshift", "isCorrect": True},
      {"label": "C", "text": "Amazon Athena", "isCorrect": False},
      {"label": "D", "text": "AWS Glue", "isCorrect": False}
    ],
    ...
    "topic": "Analytics",
    "difficulty": "MEDIUM",
    "tags": ["Redshift", "Data Warehouse", "Module 5"],
    "sourceModule": "Module 5 - Storage and Databases",
    "source": "Module 05",
    "concept": "Redshift"
  },
  {
    ...
    "options": [
      ...
      {"label": "B", "text": "S3 Intelligent-Tiering", "isCorrect": False},
      {"label": "C", "text": "S3 Standard-IA (Infrequent Access)", "isCorrect": False},
      {"label": "D", "text": "S3 Glacier Deep Archive", "isCorrect": True}
    ],
    ...
    "difficulty": "HARD",
    "tags": ["S3 Storage Classes", "Pricing", "Module 5"],
    "sourceModule": "Module 5 - Storage and Databases",
    "source": "Module 05",
    "concept": "S3 Glacier"
  },
  ...
  # Module 6: Security
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Configuring IAM user passwords", "isCorrect": False},
      {"label": "B", "text": "Securing the physical hardware in the AWS data centers", "isCorrect": True},
      {"label": "C", "text": "Encrypting customer data stored in Amazon S3", "isCorrect": False},
      {"label": "D", "text": "Patching the guest operating system on Amazon EC2 instances", "isCorrect": False}
    ],
    ...
    "difficulty": "EASY",
    "tags": ["Shared Responsibility", "Module 6"],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Create an IAM user with S3 read permissions and embed the access keys directly into the EC2 instance's code.", "isCorrect": False},
      {"label": "B", "text": "Make the S3 bucket publicly readable to allow the EC2 instance access.", "isCorrect": False},
      {"label": "C", "text": "Create an IAM role with S3 read permissions and attach the role to the EC2 instance.", "isCorrect": True},
      {"label": "D", "text": "Use the AWS account root user credentials on the EC2 instance.", "isCorrect": False}
    ],
    ...
    "topic": "IAM",
    "difficulty": "MEDIUM",
    "tags": ["IAM Role", "Best Practices", "Module 6"],
    "sourceModule": "Module 6 - Security",
    "source": "Module 06",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "IAM User", "isCorrect": False},
      {"label": "B", "text": "IAM Role", "isCorrect": False},
      {"label": "C", "text": "IAM Group", "isCorrect": True},
      {"label": "D", "text": "IAM Policy", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS CloudTrail", "isCorrect": False},
      {"label": "B", "text": "AWS Config", "isCorrect": False},
      {"label": "C", "text": "AWS Artifact", "isCorrect": True},
      {"label": "D", "text": "AWS Inspector", "isCorrect": False}
    ],
    ...
    "topic": "Compliance",
    "difficulty": "MEDIUM",
    "tags": ["Artifact", "Compliance", "Module 6"],
    "sourceModule": "Module 6 - Security",
    "source": "Module 06",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS WAF vs AWS Shield; AWS WAF provides the advanced Layer 4 DDoS protection.", "isCorrect": False},
      {"label": "B", "text": "AWS Shield Standard vs AWS Shield Advanced; AWS Shield Advanced provides the premium advanced protection.", "isCorrect": True},
      {"label": "C", "text": "AWS Inspector vs AWS GuardDuty; AWS GuardDuty provides the DDoS protection.", "isCorrect": False},
      {"label": "D", "text": "Security Groups vs Network ACLs; Security Groups provide the premium DDoS protection.", "isCorrect": False}
    ],
    ...
    "topic": "Network Security",
    "difficulty": "HARD",
    "tags": ["DDoS", "Shield", "Comparison", "Module 6"],
    "sourceModule": "Module 6 - Security",
    "source": "Module 06",
  ...
  # Module 7: Monitoring and Analytics
  {
    ...
    "options": [
      {"label": "A", "text": "AWS CloudTrail", "isCorrect": False},
      {"label": "B", "text": "Amazon CloudWatch", "isCorrect": True},
      {"label": "C", "text": "AWS Config", "isCorrect": False},
      {"label": "D", "text": "AWS Trusted Advisor", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon CloudWatch", "isCorrect": False},
      {"label": "B", "text": "AWS CloudTrail", "isCorrect": True},
      {"label": "C", "text": "AWS Identity and Access Management (IAM)", "isCorrect": False},
      {"label": "D", "text": "AWS Systems Manager", "isCorrect": False}
    ],
    ...
    "difficulty": "MEDIUM",
    "tags": ["CloudTrail", "Auditing", "Module 7"],
    "sourceModule": "Module 7 - Monitoring and Analytics",
    "source": "Module 07",
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "AWS CloudTrail", "isCorrect": False},
      {"label": "B", "text": "Amazon Macie", "isCorrect": False},
      {"label": "C", "text": "AWS Config", "isCorrect": True},
      {"label": "D", "text": "AWS Trusted Advisor", "isCorrect": False}
    ],
    ...
    "topic": "Compliance",
    "difficulty": "HARD",
    "tags": ["Config", "Compliance", "Module 7"],
    "sourceModule": "Module 7 - Monitoring and Analytics",
    "source": "Module 07",
    "concept": "AWS Config"
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "CloudWatch is used to provision resources; CloudTrail is used to delete them.", "isCorrect": False},
      {"label": "B", "text": "CloudWatch monitors resource performance metrics (like CPU usage); CloudTrail audits API calls and user activity.", "isCorrect": True},
      {"label": "C", "text": "CloudWatch is free; CloudTrail always requires a premium subscription.", "isCorrect": False},
      {"label": "D", "text": "CloudWatch audits API calls and user activity; CloudTrail monitors resource performance metrics.", "isCorrect": False}
    ],
    ...
    "topic": "Monitoring",
    "difficulty": "HARD",
    "tags": ["CloudWatch vs CloudTrail", "Comparison", "Module 7"],
    "sourceModule": "Module 7 - Monitoring and Analytics",
    "source": "Module 07",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Trusted Advisor", "isCorrect": True},
      {"label": "B", "text": "AWS Config", "isCorrect": False},
      {"label": "C", "text": "Amazon GuardDuty", "isCorrect": False},
      {"label": "D", "text": "AWS Personal Health Dashboard", "isCorrect": False}
    ],
  ...
  # Module 8: Pricing and Support
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Compute, Storage, and Outbound Data Transfer", "isCorrect": True},
      {"label": "B", "text": "Compute, Database, and Inbound Data Transfer", "isCorrect": False},
      {"label": "C", "text": "Storage, Security, and Outbound Data Transfer", "isCorrect": False},
      {"label": "D", "text": "Networking, Database, and Physical Space", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Budgets", "isCorrect": False},
      {"label": "B", "text": "AWS Cost Explorer", "isCorrect": True},
      {"label": "C", "text": "AWS Pricing Calculator", "isCorrect": False},
      {"label": "D", "text": "AWS Cost & Usage Report", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Cost Explorer", "isCorrect": False},
      {"label": "B", "text": "AWS Budgets", "isCorrect": True},
      {"label": "C", "text": "Amazon CloudWatch billing alarms", "isCorrect": False},
      {"label": "D", "text": "AWS Organizations", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Basic Support", "isCorrect": False},
      {"label": "B", "text": "Developer Support", "isCorrect": False},
      {"label": "C", "text": "Business Support", "isCorrect": False},
      {"label": "D", "text": "Enterprise Support", "isCorrect": True}
    ],
    ...
    "topic": "Support Plans",
    "difficulty": "EASY",
    "tags": ["Support Plans", "Enterprise", "Module 8"],
    "sourceModule": "Module 8 - Pricing and Support",
    "source": "Module 08",
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "AWS Cost Explorer", "isCorrect": False},
      {"label": "B", "text": "AWS Control Tower", "isCorrect": False},
      {"label": "C", "text": "AWS Organizations", "isCorrect": True},
      {"label": "D", "text": "AWS IAM Identity Center", "isCorrect": False}
    ],
    ...
    "difficulty": "HARD",
    "tags": ["Organizations", "Consolidated Billing", "Module 8"],
    "sourceModule": "Module 8 - Pricing and Support",
    "source": "Module 08",
  ...
  # Module 9: Migration & Innovation
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Migration Hub", "isCorrect": False},
      {"label": "B", "text": "AWS Application Discovery Service", "isCorrect": False},
      {"label": "C", "text": "AWS Cloud Adoption Framework (AWS CAF)", "isCorrect": True},
      {"label": "D", "text": "AWS Snowball", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "AWS Direct Connect", "isCorrect": False},
      {"label": "B", "text": "AWS Snowball Edge", "isCorrect": True},
      {"label": "C", "text": "AWS DataSync", "isCorrect": False},
      {"label": "D", "text": "Amazon S3 Transfer Acceleration", "isCorrect": False}
    ],
    ...
    "difficulty": "MEDIUM",
    "tags": ["Snowball", "Migration", "Module 9"],
    "sourceModule": "Module 9 - Migration and Innovation",
    "source": "Module 09",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Refactoring", "isCorrect": False},
      {"label": "B", "text": "Replatforming", "isCorrect": False},
      {"label": "C", "text": "Rehosting", "isCorrect": True},
      {"label": "D", "text": "Repurchasing", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Retiring", "isCorrect": False},
      {"label": "B", "text": "Rehosting", "isCorrect": False},
      {"label": "C", "text": "Refactoring / Re-architecting", "isCorrect": True},
      {"label": "D", "text": "Retaining", "isCorrect": False}
    ],
    ...
    "topic": "Migration",
    "difficulty": "HARD",
    "tags": ["6 Rs", "Refactoring", "Module 9"],
    "sourceModule": "Module 9 - Migration and Innovation",
    "source": "Module 09",
    "concept": "Refactoring"
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "People Perspective", "isCorrect": False},
      {"label": "B", "text": "Operations Perspective", "isCorrect": False},
      {"label": "C", "text": "Business Perspective", "isCorrect": True},
      {"label": "D", "text": "Governance Perspective", "isCorrect": False}
    ],
    ...
    "topic": "Migration",
    "difficulty": "EASY",
    "tags": ["CAF", "Business Perspective", "Module 9"],
    "sourceModule": "Module 9 - Migration and Innovation",
    "source": "Module 09",
  ...
  # Module 10: The Cloud Journey
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "AWS Cloud Adoption Framework", "isCorrect": False},
      {"label": "B", "text": "AWS Well-Architected Framework", "isCorrect": True},
      {"label": "C", "text": "AWS Shared Responsibility Model", "isCorrect": False},
      {"label": "D", "text": "AWS Acceptable Use Policy", "isCorrect": False}
    ],
    ...
    "difficulty": "EASY",
    "tags": ["Well-Architected", "Module 10"],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Reliability", "isCorrect": False},
      {"label": "B", "text": "Security", "isCorrect": False},
      {"label": "C", "text": "Performance Efficiency", "isCorrect": False},
      {"label": "D", "text": "Cost Optimization", "isCorrect": True}
    ],
    ...
    "topic": "Well-Architected Framework",
    "difficulty": "MEDIUM",
    "tags": ["Cost Optimization", "Well-Architected", "Module 10"],
    "sourceModule": "Module 10 - The Cloud Journey",
    "source": "Module 10",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Operational Excellence", "isCorrect": False},
      {"label": "B", "text": "Security", "isCorrect": False},
      {"label": "C", "text": "Reliability", "isCorrect": True},
      {"label": "D", "text": "Performance Efficiency", "isCorrect": False}
    ],
    ...
    "topic": "Well-Architected Framework",
    "difficulty": "MEDIUM",
    "tags": ["Reliability", "Well-Architected", "Module 10"],
    "sourceModule": "Module 10 - The Cloud Journey",
    "source": "Module 10",
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "Security", "isCorrect": False},
      {"label": "B", "text": "Performance Efficiency", "isCorrect": True},
      {"label": "C", "text": "Cost Optimization", "isCorrect": True},
      {"label": "D", "text": "Operational Excellence", "isCorrect": False},
      {"label": "E", "text": "Sustainability", "isCorrect": False}
    ],
    ...
    "topic": "Well-Architected Framework",
    "difficulty": "HARD",
    "tags": ["Well-Architected", "Multiple Pillars", "Module 10"],
    "sourceModule": "Module 10 - The Cloud Journey",
    "source": "Module 10",
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Make frequent, small, reversible changes", "isCorrect": True},
      {"label": "B", "text": "Perform operations as code", "isCorrect": False},
      {"label": "C", "text": "Anticipate failure", "isCorrect": False},
      {"label": "D", "text": "Learn from all operational failures", "isCorrect": False}
    ],
    ...
    "topic": "Well-Architected Framework",
    "difficulty": "HARD",
    "tags": ["Operational Excellence", "Design Principles", "Module 10"],
    "sourceModule": "Module 10 - The Cloud Journey",
    "source": "Module 10",
    "concept": "Design Principles"
  },

  # Module 11: Exam Basics
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Cloud Concepts", "isCorrect": False},
      {"label": "B", "text": "Security and Compliance", "isCorrect": False},
      {"label": "C", "text": "Cloud Technology and Services", "isCorrect": True},
      {"label": "D", "text": "Billing, Pricing and Support", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "To give candidates bonus points if they answer them correctly.", "isCorrect": False},
      {"label": "B", "text": "To test the testing software in a live environment.", "isCorrect": False},
      {"label": "C", "text": "To gather statistical data on new questions to evaluate their fairness for use as scored questions on future exams.", "isCorrect": True},
      {"label": "D", "text": "To intentionally lower candidate scores to enforce a strict passing rate.", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "500", "isCorrect": False},
      {"label": "B", "text": "600", "isCorrect": False},
      {"label": "C", "text": "700", "isCorrect": True},
      {"label": "D", "text": "800", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Domain 1: Cloud Concepts", "isCorrect": False},
      {"label": "B", "text": "Domain 2: Security and Compliance", "isCorrect": True},
      {"label": "C", "text": "Domain 3: Cloud Technology and Services", "isCorrect": False},
      {"label": "D", "text": "Domain 4: Billing, Pricing and Support", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "options": [
      {"label": "A", "text": "Domain 1: Cloud Concepts", "isCorrect": False},
      {"label": "B", "text": "Domain 2: Security and Compliance", "isCorrect": False},
      {"label": "C", "text": "Domain 3: Cloud Technology and Services", "isCorrect": False},
      {"label": "D", "text": "Domain 4: Billing, Pricing and Support", "isCorrect": True}
    ],
  ...
  # Module 12: Final Assessment
  {
    ...
    "options": [
      {"label": "A", "text": "Amazon EC2", "isCorrect": False},
      {"label": "B", "text": "Amazon Lightsail", "isCorrect": True},
      {"label": "C", "text": "AWS Lambda", "isCorrect": False},
      {"label": "D", "text": "AWS Elastic Beanstalk", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon RDS for PostgreSQL", "isCorrect": False},
      {"label": "B", "text": "Amazon Aurora", "isCorrect": False},
      {"label": "C", "text": "Amazon DynamoDB", "isCorrect": True},
      {"label": "D", "text": "Amazon Redshift", "isCorrect": False}
    ],
    ...
    "topic": "Databases",
    "difficulty": "MEDIUM",
    "tags": ["DynamoDB", "Application", "Module 12"],
    "sourceModule": "Module 12 - Final Assessment",
    "source": "Module 12",
    "concept": "DynamoDB Application"
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon ECS with an EC2 launch type", "isCorrect": False},
      {"label": "B", "text": "AWS Fargate", "isCorrect": True},
      {"label": "C", "text": "AWS Lambda", "isCorrect": False},
      {"label": "D", "text": "Amazon EKS with managed node groups", "isCorrect": False}
    ],
    ...
    "topic": "Compute",
    "difficulty": "HARD",
    "tags": ["Containers", "Fargate", "Module 12"],
    "sourceModule": "Module 12 - Final Assessment",
    "source": "Module 12",
    "concept": "AWS Fargate"
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Amazon GuardDuty", "isCorrect": False},
      {"label": "B", "text": "AWS Shield", "isCorrect": False},
      {"label": "C", "text": "Amazon Macie", "isCorrect": True},
      {"label": "D", "text": "AWS KMS", "isCorrect": False}
    ],
  ...
  },
  {
    ...
    "requiredSelections": 1,
    "options": [
      {"label": "A", "text": "Deploying resources across multiple Edge Locations", "isCorrect": False},
      {"label": "B", "text": "Deploying resources across multiple Availability Zones", "isCorrect": True},
      {"label": "C", "text": "Deploying resources across multiple AWS Regions", "isCorrect": False},
      {"label": "D", "text": "Deploying resources in a Local Zone", "isCorrect": False}
    ],
    ...
    "topic": "High Availability",
    "difficulty": "MEDIUM",
    "tags": ["Availability Zones", "Architecture", "Module 12"],
    "sourceModule": "Module 12 - Final Assessment",
    "source": "Module 12",
...
file_content = """// Candidate questions generated from the 12 AWS Cloud Practitioner PDF Learning Modules
...
file_content += json.dumps(questions, indent=2) + ";\n"

with open("scripts/pdf_candidates_data.ts", "w", encoding="utf-8") as f:
    f.write(file_content)

print("Generated pdf_candidates_data.ts with", len(questions), "questions!")
