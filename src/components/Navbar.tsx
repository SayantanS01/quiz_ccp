...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-800/80 bg-[#0B0F19]/90 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-400 hover:text-white hover:bg-slate-800 transition-colors"
          >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-slate-800/80 bg-[#0B0F19] px-4 py-4 space-y-2">
          <div className="flex items-center gap-2 px-3 py-2 mb-2 rounded-lg bg-slate-800/50 border border-slate-700 sm:hidden">
          ...
          <button
            onClick={handleLogout}
            className="w-full flex items-center gap-3 px-3 py-3 mt-2 rounded-lg text-sm font-semibold text-rose-400 hover:text-rose-300 hover:bg-rose-500/10 transition-colors sm:hidden"
          >
